...
#clear all data command: rm(list=ls()) 
...
Games[1,5,drop=F]
Games[1,,drop=F] #delete the dimension of an array which have only one level.
...
#Use parameters
myplot_v2<-function(data,rows=1:10){
...
myplot_v2(Salary)
myplot_v2(MinutesPlayed/Games,1:3)
#default value


myplot_v2(Salary/Games)

myplot_v2(MinutesPlayed)
myplot_v2(Points)


#In-Game Metrics Normalized

myplot_v2(FieldGoals/Games)
myplot_v2(FieldGoals/FieldGoalAttempts)
myplot_v2(FieldGoalAttempts/Games)
myplot_v2(Points/Games)
myplot_v2(FieldGoals/MinutesPlayed)

#Player Style
myplot_v2(Points/FieldGoals)
